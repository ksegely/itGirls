...
console.log(thirdFunction(4, g)); //Выведет 12
...
console.log(
	'С момента летней олимпиады в Токио прошло ' + calculateYearsSinceLastOlympics(yearNow, lastOlympicsYear) + ' года',
);
...
const yearNowForBirth = 2023;

function calculateAge(a, b) {
	return a - b;
}
console.log(calculateAge(yearNowForBirth, friendYearOfBirth));
...
let yearOfBirth;
const nowForBirth = 2023;
function alculateAge(a, b) {
	return a - b;
}
console.log(calculateAge(nowForBirth, 23));
//Задание 18
...
function calculateDegree(number, degree) {
	return number ** degree;
}
console.log(calculateDegree(3, 2));